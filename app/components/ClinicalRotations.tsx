...
export default function ClinicalRotations({ onOpenHospital }: ClinicalRotationsProps) {
  return (
    <section className="py-24 border-t border-white/5 relative bg-black" id="clinical">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <ScrollReveal variant="fade-up" delay={80} className="h-full">
            <div
              className="card-glass rounded-2xl p-8 border border-white/10 relative overflow-hidden group hover:border-[#ef233c]/50 hover:shadow-[0_16px_40px_rgba(239,35,60,0.18)] hover:-translate-y-1.5 transition-all duration-300 cursor-pointer h-full flex flex-col justify-between"
              ...
              <div>
                <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-white mt-1 group-hover:text-white transition-colors">
                      Care24 Medical Centre &amp; Hospital
                    </h3>
                    <p className="text-xs text-gray-400 mt-0.5">Erode, Tamil Nadu</p>
                  </div>
                ...
                <div className="space-y-4 text-xs text-gray-300">
                  <div>
                    <h4 className="font-bold text-white uppercase tracking-wider text-[11px] mb-2 text-[#ef233c]">
                      Advanced Clinical Systems Handled:
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-gray-300 font-light">
                      <div className="flex items-center gap-1.5 p-1 rounded hover:bg-white/5 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-3">
                      {["EEG", "EMG", "ECG", "Cath Lab", "CT Scan", "MRI Suite", "OT & OP"].map((modality) => (
                        <span
                          key={modality}
                          className="px-2.5 py-1 rounded bg-zinc-900 border border-white/10 text-[11px] text-gray-300 hover:border-red-500/30 transition-colors"
                        >
                          {modality}
                        </span>
                      ))}
