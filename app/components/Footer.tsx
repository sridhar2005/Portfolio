export default function Footer() {
  return (
    <footer className="py-8 border-t border-white/5 text-center text-xs text-gray-500 bg-black">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="tracking-wide">
          © {new Date().getFullYear()} Sridhar K. Biomedical Engineering Portfolio.
        </p>
        ...
        <div className="flex items-center space-x-3">
          <a
            ...
            className="w-8 h-8 rounded-full flex items-center justify-center border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:border-[#ef233c]/60 hover:shadow-[0_0_12px_rgba(239,35,60,0.35)] transition-all duration-300"
