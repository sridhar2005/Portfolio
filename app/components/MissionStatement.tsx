...
export default function MissionStatement() {
  ...
  return (
    <section className="py-28 border-t border-white/5 bg-black relative overflow-hidden" id="mission">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center">
        <ScrollReveal variant="fade-up">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight text-white leading-tight mb-8">
            MAKING STEADY <br />
        ...
        <ScrollReveal variant="fade-up" delay={150}>
          <div className="max-w-3xl mx-auto space-y-4 text-gray-400 text-sm sm:text-base leading-relaxed font-normal mb-16">
            <p>
          ...
          {metrics.map((m, idx) => (
            ...
            >
              <div className="flex flex-col items-center group cursor-default">
                ...
                <span className="text-xs text-gray-400 uppercase tracking-widest mt-2 group-hover:text-gray-200 transition-colors">
                  {m.label}
                </span>
              </div>
            </ScrollReveal>
