...
export default function Education() {
  const timeline = [
    ...
    },
    {
      ...
      badge: "State Board",
      badgeColor: "bg-zinc-800 text-gray-300 border-white/10",
  ...
  return (
    <section className="py-24 border-t border-white/5 relative bg-black" id="education">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative border-l-2 border-red-600/30 pl-8 ml-3 space-y-10">
          {timeline.map((item, idx) => (
            ...
            >
              <span className="absolute -left-[39px] top-1.5 w-3.5 h-3.5 rounded-full bg-[#ef233c] ring-4 ring-black group-hover:scale-150 group-hover:bg-red-400 group-hover:shadow-[0_0_12px_rgba(239,35,60,0.8)] transition-all duration-300" />
              <div className="card-glass p-6 rounded-xl border border-white/10 hover:border-red-500/40 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(239,35,60,0.15)] transition-all duration-300">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                  <h3 className="text-xl font-bold text-white tracking-wide group-hover:text-[#ef233c] transition-colors">
                    {item.degree}
                  </h3>
                  <span
                ...
                <p className="text-sm font-semibold text-gray-300 mb-2">{item.institution}</p>
